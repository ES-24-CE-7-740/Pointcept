...
sync_bn = True
num_worker = 40
num_worker_per_gpu = 30
EPOCHS = 20
LEARNING_RATE = 0.13#0.060 #0.09 # Had to be adjusted, 0.13 0.12 0.11 crashed ;(

# dataset settings
dataset_type = "TractorsAndCombinesDecAblationDataset"
data_root = "data/tractors_and_combines_ablation"
ignore_index = -1
names = [
    "other",
    "tractor",
...
data = dict(
    ...
    train=dict(
        ...
        data_root=data_root,
        transform=[
            dict(type="LimitMaxPoints", max_points=40000),
