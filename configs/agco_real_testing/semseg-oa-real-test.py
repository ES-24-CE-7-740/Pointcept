...
num_worker = 12
#/home/ai/deep_learning/Pointcept/exp/pretrain_oacnns_on_synth_wml_end/model/model_best.pth
# weight = "/workspace/Pointcept/exp/pretrain_oacnns_on_synth_wml_end/model/model_best.pth"
test_only = True
data_root = "/workspace/agco_testing/"
n_classes = 4
# model settings
model = dict(
...
# dataset settings
dataset_type = "AGCOTestingDataset"
ignore_index = -1
names = ['ground', 'unkown_tractor',  'unknown_combine_harvester',  'trailer']
data = dict(
    num_classes=n_classes,
